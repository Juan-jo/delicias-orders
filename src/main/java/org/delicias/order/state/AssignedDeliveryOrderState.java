...
public class AssignedDeliveryOrderState implements OrderState {

    @Override
    public OrderStatus getStatus() {
        return OrderStatus.DELIVERY_ASSIGNED_ORDER;
    }
    ...
    public boolean canTransitionTo(OrderStatus nextState) {
        return nextState.equals(OrderStatus.DELIVERY_ROAD_TO_STORE);
    }
