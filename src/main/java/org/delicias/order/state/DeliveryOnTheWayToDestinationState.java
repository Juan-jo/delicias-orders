...
public class DeliveryOnTheWayToDestinationState implements OrderState {

    @Override
    public OrderStatus getStatus() {
        return OrderStatus.DELIVERY_ROAD_TO_DESTINATION;
    }
    ...
    public boolean canTransitionTo(OrderStatus nextState) {
        ...
        return nextState.equals(OrderStatus.DELIVERED);
    }
